...
class IpNetworksControllerTest extends TestCase
{
    ...
    {
        $this->login();
        $this->get('/ip-networks?search=Lorem');
    ...
    {
        $this->login();
        $this->get('/ip-networks/view/' . $this->firstId('IpNetworks'));
    ...
    {
        $this->login();
        $this->get('/ip-networks/edit/' . $this->firstId('IpNetworks'));
    ...
    public function testDelete(): void
    {
        ...
        $this->post('/ip-networks/delete/' . $this->firstId('IpNetworks'));
    ...
    public function testAddUnderTheRouteFilesItUnderTheRoute(): void
    {
        ...
        $before = $this->idsIn('IpNetworks');
        $this->post('/customers/' . self::CUSTOMER_ID . '/contracts/' . self::CONTRACT_ID . '/ip-networks/add', [
            'ip_network' => '10.99.1.0/24',
            'type_of_use' => 0,
        ]);

        $this->assertRedirect();
        $added = $this->addedRecord('IpNetworks', $before);
