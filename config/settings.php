    ...
    'core' => [
        ...
        'contracts' => [
            'access_descriptions_list' => ListType::ofStrings(
                ...
                hint: __('The suggestions offered under the access description on a contract.'),
            ),
            'service_overrides' => [
        ...
        'dashboard' => [
            ...
            'contracts' => [
                'obligation_within_days' => NumberType::ofInt(
                    default: 60,
                    hint: __('How far ahead the end of a minimum term is pointed out.'),
                ),
            ],
        ],
            ...
            'contracts' => [
                ...
                'contract' => [
                    ...
                    'texts' => [
                        ...
                        'activation_fee_clause' => 'Aktivační poplatek je Uživateli poskytnut Poskytovatelem za zvýhodněných podmínek. V případě zániku této smlouvy před uplynutím {duration} od zahájení poskytování služeb je proto Uživatel povinen nahradit Poskytovateli náklady spojené se zřízením koncového bodu Poskytovatelovy sítě elektronických komunikací, a to v paušální částce {difference} ({full_fee} je aktivační poplatek při smlouvě bez úvazku).',
                        'activation_fee_clause_with_installation' => 'Poskytnutá zařízení jsou Uživateli poskytnuta Poskytovatelem za zvýhodněných podmínek (bezúplatně). V případě zániku této smlouvy před uplynutím {duration} od zahájení poskytování služeb je proto Uživatel povinen nahradit Poskytovateli náklady spojené s výše uvedenými Poskytnutými zařízeními, a to v paušální částce {difference} ({full_fee} je aktivační poplatek při smlouvě bez úvazku).',
