...
/**
 * How much each of the customer checks currently has to say.
 *
 ...
 */
class CustomerProblemsCard extends AbstractDashboardCard
{
    /**
     * @param \App\Customers\Check\CustomerCheckRegistry $checks Registry of contract checks.
     */
    public function __construct(private CustomerCheckRegistry $checks)
    {
    }
    ...
    /**
     * Aggregates over the whole customer base are not something to make the dashboard wait for.
     *
     * @return bool
     */
    #[Override]
     ...
     *
     * @param \App\Customers\Check\CustomerCheckInterface|null $only The check to show alone.
     * @return array<string, mixed>
     */
    private function overviewUrl(?CustomerCheckInterface $only = null): array
    {
        $checks = [];
