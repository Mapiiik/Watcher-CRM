...
$cakeDescription = 'Watcher CRM | ' . (string)Configure::read('App.company');
...
<body>
    <nav class="top-nav">
        ...
        <div class="top-nav-links">
            <?= $this->AuthLink->link(
                __('Dashboard'),
                ['controller' => 'Dashboard', 'action' => 'cards', 'plugin' => null, 'customer_id' => false],
            ...
            <?= $this->AuthLink->link(
                __('Files'),
                ['controller' => 'FileLinks', 'action' => 'index', 'plugin' => 'Files', 'customer_id' => false],
                ['class' => 'button button-small' . $buttonSelected([
                    'FileLinks',
                    'Storage',
                ])],
    ...
    <footer>
        ...
        <div class="container">
            <div class="float-right" title="<?= __('Changelog') . ': ' . PHP_EOL . h(Versioning::getChangelog()) ?>">
                <?= __('Source Code') ?>:
                <a href="https://github.com/Mapiiik/Watcher-CRM" target="_blank" rel="noopener">GitHub</a>,
