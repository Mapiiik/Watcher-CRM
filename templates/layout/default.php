...
<?php if (!isset($_SERVER['HTTP_REFERER']) || (strpos($_SERVER['HTTP_REFERER'], '/legacy/administration/') === false)): ?>
    <nav class="top-nav">
        ...
        <div class="top-nav-links">
            ...
            <?= $this->AuthLink->link(__('RADIUS'), ['plugin' => 'RADIUS', 'controller' => 'Accounts', 'action' => 'index'], ['class' => 'button button-small' . $buttonSelected(['Nass', 'Radacct', 'Radcheck', 'Radgroupcheck', 'Radgroupreply', 'Radpostauth', 'Radreply', 'Radusergroup'])]) ?>
