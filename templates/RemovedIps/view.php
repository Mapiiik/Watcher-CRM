...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->AuthLink->link(__('Edit Removed Ip'), ['action' => 'edit', $removedIp->id], ['class' => 'side-nav-item']) ?>
            <?= $this->AuthLink->postLink(__('Delete Removed Ip'), ['action' => 'delete', $removedIp->id], ['confirm' => __('Are you sure you want to delete # {0}?', $removedIp->id), 'class' => 'side-nav-item']) ?>
