 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $radpostauth
 */
?>
<div class="radpostauth index content">
    <?= $this->Html->link(__('New Radpostauth'), ['action' => 'add'], ['class' => 'button float-right']) ?>
